...
<table class="table table-striped table-advance table-hover">
		...
		<?php if($mode == "read"):?>
            ...
            <thead>
				<tr><th>Title</th><th>Owner</th><th>Post</th><th>Date created</th><th>Action</th></tr>
			</thead>
			<tbody>
...
<form method="post" enctype="multipart/form-data">
	...
	<img src="<?=ROOT?><?=isset($POST['image']) ? $POST['image']:'';?>" style="width: 400px;">
		...
		<?php elseif($mode == "delete_confirmed"):?>
			...
			<div class="status alert alert-success" style="">The blog was deleted successfully</div>
		...
		<?php elseif($mode == "delete" && is_object($blogs)):?>
			...
			<div class="status alert alert-danger" style="">Are you sure you want to Delete this blog??</div>
