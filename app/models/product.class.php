...
Class Product {
    ...
    public function create($DATA,$FILES, $image_class = null){
       ...
       if(!isset($_SESSION['error']) || $_SESSION['error'] == ""){
        ...
        $query = "insert into products (description,quantity,category,brand,price,date,user_url,image,image2,image3,image4,image5,slag) values (:description,:quantity,:category,:brand,:price,:date,:user_url,:image,:image2,:image3,:image4,:image5,:slag)";
