...
Class Slider {
    ...
    public function create($DATA, $FILES, $image_class = null){
        ...
        //instancirali smo error property i u prazan string stavljamo poruku 
        $this->error = "";
    ...
    //function za čitanje iz baze podataka
